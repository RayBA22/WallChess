...
**WALLCHESS** est une variante innovante du jeu d'échecs classique, développée par notre équipe dans le cadre d'un projet universitaire. Cette version enrichit la dynamique du jeu traditionnel avec l'ajout d'une pièce neutre : **le Mur**.
...
- Il **bloque les mouvements** des fous, tours, reines et des pions lors de leur premier déplacement.
